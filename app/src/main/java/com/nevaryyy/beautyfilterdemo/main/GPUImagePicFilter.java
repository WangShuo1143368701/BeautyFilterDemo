...
/**
 * Created by A on 2017/7/29.
 */

public class GPUImagePicFilter extends GPUImageTwoInputFilter {
    ...
    public GPUImagePicFilter() {
        this(1.0f);
    }

    public GPUImagePicFilter(final float intensity) {
